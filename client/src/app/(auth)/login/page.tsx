    ...
    <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-slate-50">
      <Card className="max-w-md w-full p-8 shadow-lg border-slate-200/80 bg-white">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-extrabold text-slate-900 tracking-tight">Login to MachineMatch</h2>
          <p className="mt-1 text-xs text-slate-500">Access your machinery comparisons & saved searches</p>
        </div>
